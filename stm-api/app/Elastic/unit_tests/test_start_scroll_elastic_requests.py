...
from initialize_elastic_index import start_scroll_elastic_requests

class TestStartScrollElasticRequests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_successful_post(self, mock_get_auth_header, mock_make_request_body, mock_async_client):
        ...
        response = await start_scroll_elastic_requests(sp_vars, 'token', '2024-01-01', 10, False)

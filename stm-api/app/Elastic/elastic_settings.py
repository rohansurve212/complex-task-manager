...
nested_cols = ['OrderResponse', 'source', 'OrderRelatedParty', 'SearchDetails', 'SearchFilter', 'AttributeFilter', 'AlwaysRejectFilter',
                    'FilterOperator', 'FilterGroup', 'FilterGroupOperator', 'FilterGroupModifier']
...
INDEX_NAME = 'bbm_aiml_stm_prod_v0713_3' if SMARTPATH_ENV.upper() == 'PROD' else 'bbm_aiml_stm_uat_1.2'
...
def make_elastic_query(date, filter_comp= False, query_fields=None):
